...
\include{Background}
\include{ProcessLanguageRuntime}
\include{AnalysisAndOptimization}
\include{CCSImplementation}
\include{KlaimImplementation}
\include{VSIntegration}
\include{Conclusion}
\appendix
...
% Appendix A, B, ...
\include{AppendixSoftware}
\include{AppendixBytecode}
