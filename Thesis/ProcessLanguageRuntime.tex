...
\subsection{Visitors and Formatters (NEED BETTER TITLE)}
  ...
  the object structure and calling the \textsf{Accept} method on each node in
  the object structure. A more detailed explanation of the \textit{Visitor} 
  pattern and its benefits can be found in \cite{design_patterns, visitor}.

	\lstset{language=CSharp, caption=Examples of Visit and Accept methods}
