...
namespace KLAIM.AST {
    ...
    public class ReadAction : KLAIM.AST.Action {

        public override void Accept(AbstractVisitor visitor) {
            visitor.Visit(this);
        }

        //TODO: This and InAction should be in the same class, exact same impl except
        ...
        public override void Compile(CompileContext context) {
            ...
            il.Emit(OpCodes.Ldloc, arr);
            il.Emit(OpCodes.Call, typeof(Locality).GetMethod("Read"));
