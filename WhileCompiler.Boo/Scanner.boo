...
public class Scanner:
	...
	private def NextToken() as Token:
		...
		try:
			state = start[ch]
		except converterGeneratedName2 as KeyNotFoundException:
			state = 0
		tlen = 0
		AddCh()
		converterGeneratedName3 = state
		
		if converterGeneratedName3 == (-1):
			t.kind = eofSym
			goto converterGeneratedName3_end
		elif converterGeneratedName3 == 0:
		// NextCh already done
			t.kind = noSym
			goto converterGeneratedName3_end
		:converterGeneratedName3_end
		// NextCh already done
		//-->scan3
