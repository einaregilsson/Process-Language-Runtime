...
public class Parser {
	const int _EOF = 0;
	const int _PROCNAME = 1;
	const int _PROCNAMESUB = 2;
	const int _LCASEIDENT = 3;
	const int _OUTACTION = 4;
	const int _NUMBER = 5;
	const int _ENTRYPROC = 6;
	const int maxT = 25;
...
public class Errors {
	...
	public int Count { get { return errors.Count; }}                                    // number of errors detected
  ...
  public string errMsgFormat = "-- line {0} col {1}: {2}"; // 0=line, 1=column, 2=text
	...
	public void SynErr (int line, int col, int n) {
        ...
        errors.Add(new CCSError(s, line, col));
	}
